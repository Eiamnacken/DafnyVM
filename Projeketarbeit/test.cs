...
public partial class @Stack {
  public Dafny.Sequence<BigInteger> @values = Dafny.Sequence<BigInteger>.Empty;
  public void @__ctor()
  {
    var _this = this;
  TAIL_CALL_START: ;
    _this.@values = Dafny.Sequence<BigInteger>.FromElements();
  }
  public void @pop(out BigInteger @value, out bool @fail)
  {
  ...
  TAIL_CALL_START: ;
    if (!((_this).@isEmpty()))
    {
      @value = (_this.@values).Select(new BigInteger(0));
      if ((new BigInteger((_this.@values).Length)) >= (new BigInteger(2)))
      {
        _this.@values = (_this.@values).Drop(new BigInteger(1));
      }
      else
      {
        _this.@values = Dafny.Sequence<BigInteger>.FromElements();
  ...
  public void @push(BigInteger @variable)
  {
    var _this = this;
  TAIL_CALL_START: ;
    _this.@values = (Dafny.Sequence<BigInteger>.FromElements(@variable)).@Concat(_this.@values);
  }
  public bool @isEmpty() {
    return (new BigInteger((this.@values).Length)).@Equals(new BigInteger(0));
  }
  public void @dup(out bool @fail)
  {
    @fail = false;
    var _this = this;
  TAIL_CALL_START: ;
    if (!((_this).@isEmpty()))
    {
      _this.@values = (Dafny.Sequence<BigInteger>.FromElements((_this.@values).Select(new BigInteger(0)))).@Concat(_this.@values);
      @fail = false;
    }
    else
    {
  ...
  public bool @moreThanTwo() {
    return (new BigInteger((this.@values).Length)) >= (new BigInteger(2));
  }
  public void @multi(out bool @fail)
  {
    @fail = false;
    var _this = this;
  TAIL_CALL_START: ;
    if ((_this).@moreThanTwo())
    {
      _this.@values = (Dafny.Sequence<BigInteger>.FromElements(((_this.@values).Select(new BigInteger(0))) * ((_this.@values).Select(new BigInteger(1))))).@Concat((_this.@values).Drop(new BigInteger(2)));
      @fail = false;
    }
    else
    {
...
public partial class @Interpreter {
  ...
  public void @lexer(Dafny.Sequence<BigInteger> @code, out bool @error, out BigInteger @returnValue)
  {
    @error = false;
  ...
  TAIL_CALL_START: ;
    @error = false;
    BigInteger @_3087_i = BigInteger.Zero;
    @_3087_i = new BigInteger(0);
    while ((@_3087_i) < (new BigInteger((@code).Length)))
    {
      if (((@code).Select(@_3087_i)).@Equals(new BigInteger(0)))
      {
        if ((@_3087_i) < ((new BigInteger((@code).Length)) - (new BigInteger(1))))
        {
          (_this.@stack).@push((@code).Select((@_3087_i) + (new BigInteger(1))));
          if ((@_3087_i) < (new BigInteger((@code).Length)))
          {
            @_3087_i = (@_3087_i) + (new BigInteger(1));
          }
        }
      }
      else
      if (((@code).Select(@_3087_i)).@Equals(new BigInteger(1)))
      {
        BigInteger _out0;
        bool _out1;
        (_this.@stack).@pop(out _out0, out _out1);
        @returnValue = _out0;
        @error = _out1;
      }
      else
      if (((@code).Select(@_3087_i)).@Equals(new BigInteger(2)))
      {
        bool _out2;
        (_this.@stack).@add(out _out2);
        @error = _out2;
      }
      else
      if (((@code).Select(@_3087_i)).@Equals(new BigInteger(3)))
      {
        bool _out3;
        (_this.@stack).@multi(out _out3);
        @error = _out3;
      }
      else
      if (((@code).Select(@_3087_i)).@Equals(new BigInteger(4)))
      {
        bool _out4;
        (_this.@stack).@dup(out _out4);
        @error = _out4;
      }
      if ((@_3087_i) < (new BigInteger((@code).Length)))
      {
      ...
      if (@error)
      {
        System.Console.Write(Dafny.Sequence<char>.FromString("Fehler\n"));
        goto after_0;
      }
    }
  after_0: ;
...
public partial class @__default {
  ...
  {
  TAIL_CALL_START: ;
    @Interpreter @_3088_interpreter = (@Interpreter)null;
    var _nw1 = new @Interpreter();
    @_nw1.@__ctor();
    @_3088_interpreter = _nw1;
    BigInteger @_3089_result = BigInteger.Zero;
    bool @_3090_exitCode = false;
    bool _out5;
    BigInteger _out6;
    @__default.@test(@_3088_interpreter, out _out5, out _out6);
    @_3090_exitCode = _out5;
    @_3089_result = _out6;
    BigInteger @_3091_i = BigInteger.Zero;
    @_3091_i = new BigInteger(0);
    while ((@_3091_i) < (new BigInteger((@_3088_interpreter.@stack.@values).Length)))
    {
      System.Console.Write((@_3088_interpreter.@stack.@values).Select(@_3091_i));
      System.Console.Write(Dafny.Sequence<char>.FromString("\n"));
      @_3091_i = (@_3091_i) + (new BigInteger(1));
    }
  }
  public static void @test(@Interpreter @interpreter, out bool @error, out BigInteger @result)
  {
    @error = false;
  ...
  TAIL_CALL_START: ;
    bool _out7;
    BigInteger _out8;
    (@interpreter).@lexer(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(0), new BigInteger(3), new BigInteger(0), new BigInteger(4), new BigInteger(2), new BigInteger(0), new BigInteger(6), new BigInteger(3), new BigInteger(4)), out _out7, out _out8);
    @error = _out7;
    @result = _out8;
  }
}
